# +---------------------------------------------------------------------------
# | File : license-office365-users x.x.ps1
# | Version : 0.3
# | Description : This script will license users in Office 365 from a .CSV file. Users who are already licensed will not be affected and will be written to a log file.
# | Usage : .\license-office365-users x.x.ps1
# +----------------------------------------------------------------------------
# | Maintenance History
# | -------------------
...
# | Mikail Tunc     29/09/2015   0.3      No longer prompt for CSV location. Instead define CSV and log location in the script before running
# +-------------------------------------------------------------------------------

$csvPath = "C:\csv\users.csv"
$logPath = "C:\csv\log.txt"
...
Write-Host "Note that any users who already have licenses assigned to them have not been affected by this script and have been added to the log file" -ForegroundColor Yellow
# | ----------------------------------------------------------------------------------